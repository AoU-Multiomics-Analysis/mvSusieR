...
write_tsv(
  tibble(
    variant_id = c("chr2:500_A_G", "chr3:600_C_T"),
    phenotype_id = c("ENSG_TRANS", "splice_trans"),
    pval = c(1e-10, 2e-10),
    b = c(0.4, -0.3),
    b_se = c(0.05, 0.04),
    af = c(0.2, 0.3),
...
write_tsv(
  tibble(
    ...
    start = c(150L, 250L, 500L, 350L),
    end = c(160L, 260L, 510L, 360L),
    phenotype_id = c("ENSG_CIS", "ENSG_OUT", "ENSG_TRANS", "ENSG_W2"),
    sample_1 = c(1, 2, 3, 4),
    sample_2 = c(2, 3, 4, 5)
  ),
